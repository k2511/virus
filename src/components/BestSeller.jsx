...
const Bestseller = () => {
  ...
  const maxSlides = Math.max(0, Math.ceil(filteredProducts.length / itemsToShow) - 1);
  ...
  return (
    <div className="bg-white py-6 sm:py-8 lg:py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Tab Navigation */}
        <div className="flex flex-wrap gap-2 mb-6 lg:mb-8 border-b border-gray-200">
          {tabs.map((tab) => (
            <button
              key={tab}
              onClick={() => setActiveTab(tab)}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {filteredProducts.map((product) => (
            <div key={product.id} className="bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-300">
              {/* Product Image */}
              <div className="relative bg-gray-100 h-48 flex items-center justify-center p-4">
                ...
                <button
                  onClick={() => handleWishlist(product)}
                  className="absolute top-3 right-3 bg-white rounded-full p-2 shadow-sm hover:shadow-md transition-shadow"
                >
              ...
              <div className="p-4">
                ...
                <div className="flex gap-2">
                  <button
                    onClick={() => handleAddToCart(product)}
                    className="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded text-sm transition-colors duration-200 flex items-center justify-center gap-2"
                  >
                    <ShoppingCart size={14} />
                    Add to Cart
                  </button>
                  <button className="bg-gray-100 hover:bg-gray-200 text-gray-700 p-2 rounded transition-colors duration-200 flex items-center justify-center">
                    <Shield size={14} />
                  </button>
                </div>
              </div>
