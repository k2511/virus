...
//   const tabs = ['All Products', 'Total Secruity', 'Internet Secruity', 'Antivirus Pro','Upgrade'];
...
//       image: "https://via.placeholder.com/200/200/ffffff/000000?text=Internet+Security+1U+1Y",
//       price: "$24.99",
//       originalPrice: "$34.99",
//     },
//     {
...
//     //   id: 10,
//     //   category: "Antivirus Pro",
//     //   name: "Quick Heal Antivirus Pro 3 User 1 Years",
...
//     //   id: 11,
//     //   category: "Total Security",
//     //   name: "Upgrade Quick Heal Total Security 2 User 1 Years",
...
//     //   id: 12,
//     //   category: "Total Security",
//     //   name: "Upgrade Quick Heal Total Security 3 User 1 Years",
...
//                 <h4 className="text-blue- font-medium mb-2">Quick Heal Total Security 1PC 3
// Vonre</h4>
...
//                   <span>Available: <span className="font-semibold">6</span></span>
//                   <span>Already Sold: <span className="font-semibold">28</span></span>
//                 </div>
...
//             <div className="flex flex-wrap gap-1 mb-8 bg-gray-100 rounded-lg p-1 w-[100%] ml-[0px] mr-[30px]">
//               {tabs.map((tab) => (
//                 <button
//                   key={tab}
...
//     const calculateTimeLeft = () => {
//       const targetDate = new Date();
//       targetDate.setHours(targetDate.getHours() + 12); // 12 hours from now (until 08:33 AM IST, August 26, 2025)
...
//                 )
//                 .slice(0, activeTab === "All Products" ? visibleProducts : products.length) // Limit visible products for "All Products" tab
//                 .map((product) => (
//                   <div key={product.id} className="group">
//                     <div className="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-lg transition-shadow">
//                       <div className="text-xs text-gray-500 mb-2">{product.category}</div>
...
//             {/* View More Button (only for All Products tab) */}
            ...
            <div className="flex flex-wrap gap-1 mb-8 bg-gray-100 rounded-lg p-1 w-full">
              {tabs.map((tab) => (
                <button
                  ...
                  onClick={() => {
                    setActiveTab(tab);
                    setVisibleProducts(4); // Reset to initial 4 products when switching tabs
                  }}
                  className={`px-6 py-2 rounded-md font-medium transition-all ${
                    activeTab === tab
                      ? "bg-white text-gray-900 shadow-sm"
