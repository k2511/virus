            ...
            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 sm:gap-0 ">
              {products
                ...
                .map((product) => (
                  ...
                  >
                    <div className="bg-white border-2 border-gray-300 mb-4 sm:p-4 p-3 transition-all duration-200 m-1 hover:border-gray-300  hover:shadow-[0px_0px_6px_rgba(0,0,0,0.3)] ">
