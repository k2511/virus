    ...
    <div className="w-full bg-white min-h-screen">
      ...
      >
        ...
        <ul className="space-y-3">
         ...
         {/* Sidebar */}
      {/* <div
        className={`fixed top-0 left-0 h-full w-64 bg-gray-200 text-white p-6 transform ${
          showslide ? "translate-x-0" : "-translate-x-full"
        } transition-transform duration-300 ease-in-out z-50`}
      >
        <div className="flex items-center border-2 border-white justify-between">
           <h2 className="text-2xl text-black font-bold "> <img src={alogo}/> </h2> <X
                  onClick={() => setShowSlide(!showslide)}
                  className="w-20 h-20 cursor-pointer text-black"
                />
        </div>
       
        <ul className="space-y-4 text-black">
          <li className="hover:text-gray-300 cursor-pointer">Value</li>
      ...
      style={{ marginBottom: "-5px", enableBackground: "new 0 0 300 126.5" }}
...
>
  ...
  <ul className="space-y-4 text-black mt-6 px-4 text">
    <li className="hover:text-gray-300 cursor-pointer">Antivirus Software </li>
    ...
    <li className="hover:text-gray-300 cursor-pointer">Windows</li>
    <li className="hover:text-gray-300 cursor-pointer">Office 365</li>
    <li className="hover:text-gray-300 cursor-pointer">Accounting Software</li>
    <li className="hover:text-gray-300 cursor-pointer">Tally</li>

    <li className="hover:text-gray-300 cursor-pointer">QuickBooks</li>
    <li className="hover:text-gray-300 cursor-pointer">Zoho Books</li>
  </ul>
