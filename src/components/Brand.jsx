  ...
  return (
    <div className="min-h-screen bg-white p-4 lg:p-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-wrap gap-2 mb-8 bg-gray-100 rounded-lg p-2 justify-between">
          {list.map((brand, idx) => (
            <button
              key={idx}
              onClick={() => setVal(idx)}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {list[val].arr.map((item, i) => (
            <div key={i} className="group">
              <div className="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-xl transition-shadow duration-300">
                <div className="text-xs text-gray-500 mb-2 bg-gray-50 px-2 py-1 rounded-full inline-block">
                  {item.category}
                </div>
                <h3 className="text-blue-600 font-medium text-sm mb-3 line-clamp-2 hover:underline cursor-pointer transition-colors duration-300">
                  {item.name}
                </h3>
                <div className="mb-4 bg-gray-50 rounded-lg p-4 h-32 flex items-center justify-center overflow-hidden">
                  <img
                    src={item.img}
                    alt={item.name}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="bg-yellow-400 hover:bg-yellow-500 text-white p-2 rounded-full transition-colors duration-300"
                  >
                    <ShoppingCart className="w-4 h-4" />
                  </button>
                </div>
                <div className="flex items-center gap-4 mt-3 text-xs text-gray-500">
                  <button className="flex items-center gap-1 hover:text-gray-700 transition-colors duration-300">
