...
//                     </button>
//                   </div>
//                   <div className="flex justify-center text-sm text-gray-500 mt-4 opacity-0 group-hover:opacity-100 transition-opacity">
...
//                     </button>
//                   </div>
//                   <div className="flex justify-center text-sm text-gray-500 mt-4 w-full opacity-0 group-hover:opacity-100 transition-opacity">
//                     Compare • Add to Wishlist
//                   </div>
//                 </div>
//               </div>
            ...
            >
              {list[val].arr.slice(0, visibleCount).map((item, i) => (
                ...
                >
                  ...
                  <div className="flex justify-center text-sm text-gray-500 mt-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    Compare • Add to Wishlist
                  </div>
                </div>
              ))}
            ...
            >
              <div className="w-full">
                ...
                <div className="w-full">
                  ...
                  <div className="flex justify-center text-sm text-gray-500 mt-4 w-full opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    Compare • Add to Wishlist
                  </div>
                </div>
              </div>
